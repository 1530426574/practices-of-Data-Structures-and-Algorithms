...
def moves(i,j):
    ...
    #         a.append((di,dj))
    # return tuple(a)
    return [(i + _i,j + _j) for _i , _j in ((-1,0),(0,1),(1,0),(0,-1)) if i + _i >=0 and j + _j >=0 and i + _i < len(board) and j + _j < len(board[0])]
...
d1 = {i: v for i ,v in enumerate([tuple([i * 3 +j for i ,j in item])\
                                ...
                                for _i , _j in ((-1,0),(0,1),(1,0),(0,-1))\
                                if i + _i >=0 and j + _j >=0 and i + _i < len(board) and j + _j < len(board[0])]
